...
const colorPickerList = ["#c51f1f", "#c58a1f", "#9cc51f", "#1fc571", "#1fb6c5", "#1f43c5", "#6e1fc5", "#c51f8a", "#c51f3e", "#212121"];
// new activity window
...
function addNewActivity(){
  ...
  let newAct = new Activity(name_NEWACTV.value, selectedColor_NEWACTV, start_NEWACTV.value, end_NEWACTV.value, selectedCategory_NEWACTV);
...
plannerBar.onclick = toggleAddActivityTab;
...
let activityList = []
let selectedCategory_NEWACTV = 0; // work, study, rest, relax, other
let selectedColor_NEWACTV = null;
